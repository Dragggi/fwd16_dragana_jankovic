...
if(isset($_POST['Submit'])) { 
   $planeMakerName = $_POST['planeMakerName'];
    ...
    if(empty($planeMakerName)){ 
        ...
        // $query->execute(array(':movieName' => $movieName, ':categoryId' => $categoryId));
...
td {
    ...
    <body>
        <a href="aeroplaneMaker.php">Home</a>  | <a href="aeroplane.php">Plane</a><br/><br/>
...
<td>
PlaneMakerName <br><input type='text' name="planeMakerName" >
<br><br>
</td>
