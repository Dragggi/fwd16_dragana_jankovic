...
<!-- Länk till lägga till nya film -->        
        <a href="add_form.php">Add New Song</a><br/><br/>
...
*/    
    while($row = $result->fetch()) {         
        ...
        echo "<td><a href=\"edit.php?idsong=$row[idsong]\">Edit</a> | <a href=\"delete.php?idsong=$row[idsong]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
    } 
    ?>
    </table>
    </body>
